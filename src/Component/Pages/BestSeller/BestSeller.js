...
const BestSeller = () => {
    return (
        <div className='my-20 mx-10 py-10 rounded-xl border-2 border-yellow-600 shadow-lg'>

<div className='flex justify-center'>
    <h2 className='border-b-2 w-2/12 text-center text-2xl mb-7'>BEST 3 SELLERS</h2>
</div>
