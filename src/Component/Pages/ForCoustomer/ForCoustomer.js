    ...
    return (
        <div className=' my-20 py-40 bg-no-repeat border bg-cover' style={{ backgroundImage: `url('https://i.ibb.co/R9MTXr3/c-cover.png')` }}>
            ...
            <div className='text-center relative'>
                <h2 className='font-serif text-3xl pb-3 text-slate-300 '>Yes! Send me exclusive offers, unique gift ideas, and personalised tips for shopping and selling on Etsy.</h2>
